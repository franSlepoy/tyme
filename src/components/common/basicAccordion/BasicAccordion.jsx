    ...
    <Box mt={"24px"} >
      <Accordion>
        <AccordionSummary
          ...
          id="panel1a-header"
        >
          <Typography sx={{fontFamily: "Manrope", fontSize:"24px", fontWeight:300, lineHeight:"34px", color:"#003350"}}>Radiografía Transformadora de organizaciones: Evaluación y Diagnóstico</Typography>
        </AccordionSummary>
        <AccordionDetails>
      ...
      <Accordion>
        <AccordionSummary
          ...
          id="panel2a-header"
        >
          <Typography sx={{fontFamily: "Manrope", fontSize:"24px", fontWeight:300, lineHeight:"34px", color:"#003350"}}>Conexión real con la Experiencia del empleado</Typography>
        </AccordionSummary>
        <AccordionDetails>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Typography sx={{mt:3,fontFamily: "Manrope", fontSize:"14px", fontWeight:300, lineHeight:"24px", color:"#003350"}}>
          Cuando la persona toca el + dentro de ese servicio el texto debe decir: “Una certificación es una herramienta para validar el compromiso de una empresa con altos estándares de calidad, responsabilidad y cumplimiento. Empresas más comprometidas con la sociedad, con sus propios empleados y con el planeta. Además de aumentar la credibilidad y la confianza, la certificación puede abrir oportunidades comerciales y fomentar una cultura de mejora continua en la organización. En Tyme, estamos dedicados a acompañarte en cada paso del camino hacia la certificación, asegurando que tu empresa cumpla con los estándares y esté preparada para lo que se propone”.
          </Typography>
          <Button sx={{borderRadius:"100px", border: "1px solid", color:"#003350", mt:3 }} variant='outlined'>Ver servicios</Button>
        </AccordionDetails>
      </Accordion>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Typography sx={{mt:3,fontFamily: "Manrope", fontSize:"14px", fontWeight:300, lineHeight:"24px", color:"#003350"}}>
          ofrecemos un servicio de mentoring personalizado diseñado para líderes que deseen dar un paso hacia la transformación digital. Nuestro enfoque se centra en brindar asesoramiento especializado para evaluar digitalmente la gestión del departamento de Recursos Humanos y guiar a tu organización hacia una estrategia de transformación exitosa. Ver Servicios Charlas y conferencias.
          </Typography>
