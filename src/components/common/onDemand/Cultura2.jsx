  ...
  return (
    ...
    >
      ...
      <Box>
        ...
        >
          Junto a profesionales de diversas disciplinas y experiencia en management y RRHH, desarrollamos planes de mejora.
        </Typography>
      </Box>
...
creamos planes a medida, con foco en el desarrollo de talentos.
        ...
        <Box ml={"4%"} maxWidth={"200px"}>
          ...
          <Typography sx={{
            ...
            Ejecución: ponemos en marcha la estrategia, alineada a tus metas de crecimiento.
          </Typography>
        </Box>
        <Box ml={"4%"} maxWidth={"200px"}>
          <Typography
          ...
          <Typography sx={{
              ...
              mt: 2,
                ...
                monitoreamos los resultados y medimos su impacto directo en el negocio.
            </Typography>
        </Box>
      </Box>
