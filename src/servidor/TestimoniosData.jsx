export const TestimoniosCradData = [
    ...
    {id: 1,
        ...
        empresa:"AXA, compañía de seguros."
        
       },
       {id: 2,
        imagen: "/testimonios2.png",
        nombre: "Alberto Benbunan",
        texto:"Tyme ha sido más que un simple asesor para nosotros; han sido un verdadero socio estratégico en la digitalización de nuestro Departamento de Talento. Gracias a su colaboración crucial, hemos podido implementar herramientas digitales innovadoras que no solo han agilizado nuestros procesos operativos, sino que también han permitido una mayor personalización en el desarrollo y crecimiento profesional de todo nuestro equipo.",
        cargo:"Founder &amp; CEO Europa y LATAM. ",
        empresa:"GELT, startup de cashback / Emprendedor Endeavor"
        
       },
       {id: 3,
        imagen: "/testimonios3.png",
        nombre: "Carlos Zucchi",
        texto:"Tyme ha sido un socio esencial para nuestra estrategia de gestión de talento. Somos una organización en constante crecimiento y nos ayudó a diagnosticar a nuestros líderes, captando también nuevos talentos, y logrando así una positiva transformación hacia un equipo de alto rendimiento. Se nota la vocación de servicio, entusiasmo y profesionalismo de todo el equipo de Tyme.",
        cargo:"CEO &amp; Partner – España e Israel",
        empresa:"Argis: promotora y fondo de capital de riesgo en Real Estate."
       ...
       {id: 5,
        imagen: "/testimonios5.png",
        nombre: " Sebastián Moguilevski",
        texto:"Javier tiene muy buen ojo para evaluar a las organizaciones, encontrando asertivamente las fortalezas y oportunidades de los líderes. Siempre con mucho entusiasmo, pero por sobre todo con mucha escucha y empatía. Se nota la formación constante que tienen en todo lo referido a Recursos Humanos, demostrando ser expertos en la optimización de talento y desarrollo organizacional",
        cargo:"CEO &amp; Managing Director",
        empresa:"Warner Bros España y Portugal"
       ...
       {id: 6,
        ...
        empresa:"The Cyranos – agencia de Marketing y Publicidad -  Ex. presidente mundial Walter Thompson - Board member de Cleverman NY y de The Keenfolks USA."
       ...
       {id: 7,
        ...
        empresa:"PHV Latam, empresa de servicios de soporte en vigilancia sanitaria e info médica."
       ...
       {id: 8,
        ...
        empresa:"Mutare Life, startup digital de educación y bienestar."
